...
// Loon
[Script]
cron "1 0-18/6 * * *" script-path=https://raw.githubusercontent.com/zhdeveloper/jdmattresswoolactions/master/jd_818.js,tag=京东手机狂欢城
// Surge
京东手机狂欢城 = type=cron,cronexp=1 0-18/6 * * *,wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/zhdeveloper/jdmattresswoolactions/master/jd_818.js
 */
...
async function showMsg() {
  ...
  if (nowTime > new Date(activeEndTime).getTime()) {
    $.msg($.name, '活动已结束', `该活动累计获得京豆：${$.jbeanCount}个\niOS用户请删除此脚本\ngithub action用户请删除.github/workflows/jd_818.yml文件\n如果帮助到您可以点下🌟STAR鼓励我一下,谢谢\n咱江湖再见\nhttps://github.com/zhdeveloper/jdmattresswoolactions`, {"open-url": "https://github.com/zhdeveloper/jdmattresswoolactions"});
    if ($.isNode()) await notify.sendNotify($.name + '活动已结束', `请删除此脚本\ngithub action用户请删除.github/workflows/jd_818.yml文件\n如果帮助到您可以点下🌟STAR鼓励我一下,谢谢\n咱江湖再见\n https://github.com/zhdeveloper/jdmattresswoolactions`)
  } else {
